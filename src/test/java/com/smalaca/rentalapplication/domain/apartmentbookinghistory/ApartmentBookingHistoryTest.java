...
class ApartmentBookingHistoryTest {
    ...
    private static final LocalDate END_1 = LocalDate.of(2040, 10, 12);
    private static final Period PERIOD_1 = Period.from(START_1, END_1);
    ...
    private static final LocalDate START_2 = LocalDate.of(2041, 1, 2);
    private static final LocalDate END_2 = LocalDate.of(2041, 3, 4);
    private static final Period PERIOD_2 = Period.from(START_2, END_2);
    ...
    void shouldRecognizeTwoInstancesOfApartmentBookingHistoryRepresentsTheSameAggregateEvenWithDifferentApartmentBooking() {
        ApartmentBookingHistory toCompare = givenApartmentBookingHistory();
        toCompare.addBookingStart(BOOKING_DATE_TIME_3, OWNER_ID, TENANT_ID_2, Period.from(START_1, END_2));
    ...
    private ApartmentBookingHistory givenApartmentBookingHistory() {
        ...
        apartmentBookingHistory.addBookingStart(BOOKING_DATE_TIME_1, OWNER_ID, TENANT_ID_1, Period.from(START_1, END_1));
